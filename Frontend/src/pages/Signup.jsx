...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    setSubmitting(true);
    try {
      // Creates the account but doesn't log the user in automatically —
      // they log in explicitly with their new credentials next.
        ...
        <div className="flex items-center justify-center p-6 sm:p-12 lg:p-16 bg-surface w-full">
          <div className="w-full max-w-md bg-surface-container-low rounded-xl p-8 sm:p-10 shadow-xl flex flex-col gap-6">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
              ...
              <button
                className="w-full bg-primary text-on-primary text-label-md py-3.5 px-4 rounded-lg hover:opacity-95 transition-all shadow-md mt-2 flex items-center justify-center gap-2 disabled:opacity-60"
                type="submit"
                disabled={submitting}
              >
